 ...
 // JDBC connection details
    ...
    try {
        ...
        if (conn != null) {
            ...
            String sql = "SELECT customer_type, COUNT(customer_type) AS common_customer FROM sales GROUP BY customer_type ORDER BY common_customer DESC LIMIT 1";
            stmt = conn.createStatement();
            rs = stmt.executeQuery(sql);

            while (rs.next()) {
            	city = rs.getString("customer_type");
                total_revenue = rs.getInt("common_customer");
                %>
