 ...
 // JDBC connection details
    ...
    try {
        ...
        if (conn != null) {
            ...
            String sql = "SELECT product_line, ROUND(AVG(rating),2) average_rating FROM sales GROUP BY product_line ORDER BY average_rating DESC";
            stmt = conn.createStatement();
            rs = stmt.executeQuery(sql);

            while (rs.next()) {
            	city = rs.getString("product_line");
                total_revenue = rs.getInt("average-rating");
                %>
