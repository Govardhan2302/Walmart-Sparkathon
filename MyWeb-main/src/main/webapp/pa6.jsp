...
<!-- Navigation Bar -->
    ...
    <h2>Highest Revenue Product Lines</h2>
 ...
 // JDBC connection details
    ...
    try {
        ...
        if (conn != null) {
            ...
            String sql = "SELECT product_line, SUM(total) AS total_revenue FROM sales GROUP BY product_line ORDER BY total_revenue DESC";
