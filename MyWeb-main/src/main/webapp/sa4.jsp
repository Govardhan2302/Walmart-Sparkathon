 ...
 // JDBC connection details
    ...
    try {
        ...
        if (conn != null) {
            ...
            String sql = "SELECT customer_type, SUM(VAT) AS total_VAT FROM sales GROUP BY customer_type ORDER BY total_VAT DESC LIMIT 1;";
            stmt = conn.createStatement();
            rs = stmt.executeQuery(sql);

            while (rs.next()) {
            	city = rs.getString("customer_type");
                total_revenue = rs.getInt("total_VAT");
                %>
