 ...
 // JDBC connection details
    ...
    try {
        ...
        if (conn != null) {
            ...
            String sql = "SELECT day_name, time_of_day, COUNT(invoice_id) AS total_sales FROM sales GROUP BY day_name, time_of_day HAVING day_name NOT IN ('Sunday','Saturday');";
