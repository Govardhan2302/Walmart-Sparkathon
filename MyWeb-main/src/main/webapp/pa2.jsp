 ...
 // JDBC connection details
    ...
    try {
        ...
        if (conn != null) {
            ...
            String sql = "SELECT payment, COUNT(payment) AS common_payment_method FROM sales GROUP BY payment ORDER BY common_payment_method DESC";
            stmt = conn.createStatement();
            rs = stmt.executeQuery(sql);

            while (rs.next()) {
            	paymentMethod = rs.getString("payment");
                commonPayment = rs.getInt("common_payment_method");
                %>
