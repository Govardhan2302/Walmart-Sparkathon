 ...
 // JDBC connection details
    ...
    try {
        ...
        if (conn != null) {
            ...
            String sql = "SELECT COUNT(DISTINCT product_line) AS productLineCount FROM sales";
            stmt = conn.createStatement();
            rs = stmt.executeQuery(sql);

            if (rs.next()) {
                productLineCount = rs.getInt("productLineCount");
            }
