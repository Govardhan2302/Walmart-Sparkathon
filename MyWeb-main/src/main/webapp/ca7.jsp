 ...
 // JDBC connection details
    ...
    try {
        ...
        if (conn != null) {
            ...
            String sql = "SELECT time_of_day, AVG(rating) AS average_rating FROM sales GROUP BY time_of_day ORDER BY average_rating DESC LIMIT 1";
            stmt = conn.createStatement();
            rs = stmt.executeQuery(sql);

            while (rs.next()) {
            	city = rs.getString("time_of_day");
