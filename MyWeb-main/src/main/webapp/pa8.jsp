...
<!-- Navigation Bar -->
    ...
    <h2>Highest VAT Product Line</h2>
 ...
 // JDBC connection details
    ...
    try {
        ...
        if (conn != null) {
            ...
            String sql = "SELECT product_line, SUM(vat) as VAT FROM sales GROUP BY product_line ORDER BY VAT DESC";
            stmt = conn.createStatement();
            rs = stmt.executeQuery(sql);

            while (rs.next()) {
            	product_line = rs.getString("product_line");
                VAT= rs.getInt("VAT");
                %>
